...
namespace menu {
	...
	namespace misc::vars {
		...
		struct variables {
			...
			std::mutex m;
			bool update = false;
			std::string HUD_MPREENTER = { "Joining Session with monopoly" };
			std::string HUD_JOINING = { "Loading GTA Online with monopoly" };
			std::string PM_QUIT_MP = { "Leave GTA Online with monopoly" };
			std::string PM_ENTER_MP = { "Join GTA Online with monopoly" };
			std::string PM_EXIT_GAME = { "Exit Game with monopoly" };
			std::string PM_GO = { "Go Online with monopoly" };
			std::string PM_FRIEND_FM = { "Join Friend with monopoly" };
			std::string PM_FIND_SESS = { "Find New Session with monopoly" };
