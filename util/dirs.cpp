...
namespace util::dirs {
	...
	bool directories::load() {
		...
		sprintf_s(m_paths[PATH_MONOPOLY], ("%s\\monopoly"), m_paths[PATH_DOCUMENTS]);
		sprintf_s(m_paths[PATH_GFX], ("%s\\fonts\\"), m_paths[PATH_MONOPOLY]);
		sprintf_s(m_paths[PATH_TEXTURES], ("%s\\textures\\"), m_paths[PATH_MONOPOLY]);
		sprintf_s(m_paths[PATH_LOG], create_string(m_paths[PATH_MONOPOLY], ("log.txt")).c_str());
		sprintf_s(m_paths[PATH_GFX], ("%s\\fonts\\"), m_paths[PATH_MONOPOLY]);
		sprintf_s(m_paths[PATH_HEADERS], ("%s\\headers\\"), m_paths[PATH_MONOPOLY]);
		sprintf_s(m_paths[PATH_THEME], ("%s\\themes\\"), m_paths[PATH_MONOPOLY]);
		sprintf_s(m_paths[PATH_AUTH], create_string(m_paths[PATH_MONOPOLY], XOR("auth.json")).c_str());

		bool success = create_directories({
			m_paths[PATH_MONOPOLY],
			create_string(m_paths[PATH_MONOPOLY], ("headers")),
			create_string(m_paths[PATH_MONOPOLY], ("textures")),
			create_string(m_paths[PATH_MONOPOLY], ("fonts")),
			create_string(m_paths[PATH_MONOPOLY], ("themes")),
			create_string(m_paths[PATH_MONOPOLY], ("translations"))
			});
